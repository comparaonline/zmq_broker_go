...
func init() {
	...
	flag.StringVar(&front_address, "front_address", "tcp://*:5559", "address to bind for octophone clients")
	flag.StringVar(&back_address, "back_address", "tcp://*:5560", "address to bind for comparador servers")
